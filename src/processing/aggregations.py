...
def vehicle_speed_summary(df: DataFrame, window_duration: str = "1 minute") -> DataFrame:
...
def engine_health_summary(df: DataFrame, window_duration: str = "5 minutes") -> DataFrame:
...
def imu_vibration_summary(df: DataFrame, window_duration: str = "1 minute") -> DataFrame:
